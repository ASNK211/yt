<template>
  <div style="padding: 0">
    <h1 style="font-weight: 800; font-size: larger">withdraw history</h1>
...
export default {
  ...
  async created() {
    const response = await AuthenticationServices.getwithdrawhistory();
